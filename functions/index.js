...
export async function onRequest(context) {
  ...
  if (S.layout_menu_layout === 'horizontal') {
    ...
    if (!S.home_hide_github) {
      githubIconHtml = `
        <a href="https://github.com/" target="_blank" class="fixed top-4 left-4 z-50 hidden min-[550px]:flex items-center justify-center p-2 rounded-lg bg-white/80 backdrop-blur shadow-md hover:bg-white text-gray-700 hover:text-black dark:bg-gray-800/80 dark:text-gray-200 dark:hover:text-white transition-all" title="GitHub">
